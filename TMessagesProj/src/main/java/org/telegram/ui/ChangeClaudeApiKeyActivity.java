 ...
 */
public class ChangeClaudeApiKeyActivity extends BaseFragment {
    ...
    public ChangeClaudeApiKeyActivity(Theme.ResourcesProvider resourcesProvider) {
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("ChangeClaudeApiKey", R.string.ChangeClaudeApiKey));
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    Browser.openUrl(getParentActivity(),
                            LocaleController.getString("FindClaudeKeyUrl", R.string.FindClaudeKeyUrl));
                }
            }
        });
        ...
        firstNameField.setHint(LocaleController.formatApiKey(UserConfig.getInstance(currentAccount).apiKeyClaude));
    ...
    private void saveApiKey() {
        ...
        String apiKey = UserConfig.getInstance(currentAccount).apiKeyClaude;
        ...
        if (newFirst.length() == 0) {
            ...
            AlertDialog alertDialog = AlertsCreator.createSimpleAlert(getContext(),
                    LocaleController.getString("ChangeClaudeApiKey", R.string.ChangeClaudeApiKey),
    ...
    private void changeApiKey(String newFirst) {
        ...
        UserConfig.getInstance(currentAccount).apiKeyClaude = newFirst;
        UserConfig.getInstance(currentAccount).saveConfig(false);

        NotificationCenter.getInstance(currentAccount)
                .postNotificationName(NotificationCenter.updateInterfaces, MessagesController.UPDATE_MASK_CLAUDE_API_KEY);
    ...
    private void verifyKey() {
        ...
        if (firstNameField.getText() == null) {
            ...
            newFirst = UserConfig.getInstance(currentAccount).apiKeyClaude;
        }

        if (TextUtils.isEmpty(newFirst) || checkValue(newFirst)) return;

        openAiService.changeLLMToken(newFirst, LLMType.anthropic);
        ...
        openAiService.createChatACompletion(completionRequest, new OpenAiService.ResultACallBack() {
            ...
            public void onSuccess(ChatACompletionResponse result) {
                AndroidUtilities.runOnUIThread(() -> {
                    ...
                    AlertsCreator.showSimpleAlert(ChangeClaudeApiKeyActivity.this,
